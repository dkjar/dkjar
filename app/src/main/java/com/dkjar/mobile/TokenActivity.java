...
import com.dkjar.autocomplete.CompleteTextView;
import com.dkjar.autocomplete.FilteredArrayAdapter;
import com.dkjar.common.Intents;

import java.util.List;

public class TokenActivity extends AppCompatActivity implements CompleteTextView.TokenListener {
    ...
    public static Intent createIntent() {
        return new Intents.Builder("TOKEN").toIntent();
    }

...
/* package */
class SimpleViewPagerIndicator extends View implements OnWelcomeScreenPageChangeListener {
    ...
    private int currentPageColor = 0x99000000;
    private int otherPageColor = 0x44000000;
